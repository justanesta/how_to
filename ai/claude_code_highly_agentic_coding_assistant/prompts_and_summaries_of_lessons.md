...
* `#`: Use `#` to quickly add a memory. Useful when you see Claude Code repeats an error.
  * __Example 1__: since the project is a `uv` project, we added these to `CLAUDE.md` file using `#`:
    * `#use uv to run python files or add any dependencies`
  * __Example 2__: you can inform Claude Code about the database schema, in this case since you have a vector database, you can inform Claude Code about the collections stored in the vector database:
